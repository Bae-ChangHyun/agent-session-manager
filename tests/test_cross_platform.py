...
class TestDecodePathHint:
    ...
    def test_unix_standard(self):
        ...
        with patch("cc_tui.models.IS_WINDOWS", False):
    ...
    def test_windows_drive_letter(self):
        ...
        with patch("cc_tui.models.IS_WINDOWS", True):
...
class TestDirSize:
    def test_windows_skips_du(self, tmp_path: Path):
        ...
        with patch("cc_tui.services.claude_data.sys") as mock_sys:
            mock_sys.platform = "win32"
            from cc_tui.services.claude_data import _dir_size
...
class TestBackupSymlinks:
    def test_windows_no_symlinks(self):
        import cc_tui.services.backup  # noqa: F401
...
class TestMigrateDecoding:
    def test_uses_decode_path_hint(self):
        ...
        from cc_tui.services import migrate
